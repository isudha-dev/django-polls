...
def create_question(question_text, days):
    ...
    (negative for questions published in the past, positive for questions that are yet to be published"""
...
class QuestionIndexViewTests(TestCase):
    def test_no_question(self):
        """If no questions exists, an appropriate massage is displayed."""
    ...
    def test_past_question(self):
        ...
        question = create_question("Past questions?", -30)
        response = self.client.get(reverse("polls:index"))
    ...
    def test_past_question_future_question(self):
        """Even if both the Questions with future and past pub_date exists only past pub_date questions are displayed"""
        create_question("Future question?", 30)
    ...
    def test_two_past_questions(self):
        ...
        question1 = create_question("Past questions1?", -30)
        question2 = create_question("Past questions2?", -15)
        response = self.client.get(reverse("polls:index"))
